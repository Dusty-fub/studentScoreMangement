      ...
      $(function () {
        ...
        $("#register").click(function () {
          ...
          if (exam == null) {
            ...
            if (exam.type == 2) {
              ...
              $("#regClazzList").combobox("options").queryParams = {
                gradeid: exam.gradeid,
              };
              $("#regClazzList").combobox("options").url =
                "TeacherServlet?method=GetExamClazz";
        ...
        $("#escore").click(function () {
          ...
          if (exam == null) {
            ...
            setTimeout(function () {
              $("#escoreList").datagrid("options").url =
                "ScoreServlet?method=ScoreList&t=" + new Date().getTime();
            ...
            $.ajax({
              ...
              success: function (result) {
                ...
                for (var i = 0; i < courseList.length; i++) {
                  ...
                  var radioTd = $("<td></td>");
                  var radioInput = $(
                    "<input class='course' type='radio' name='course' />"
                  ).attr({
                    gradeid: gradeId,
                    clazzid: clazzId,
                    courseid: courseId,
        ...
        $("#regClazzList").combobox({
          ...
          onChange: function (newValue, oldValue) {
            ...
            //加载该年级下的班级
            $("#regCourseList").combobox("clear");
            $("#regCourseList").combobox("options").queryParams = {
              gradeid: exam.gradeid,
              clazzid: newValue,
            };
            $("#regCourseList").combobox("options").url =
              "TeacherServlet?method=GetExamCourse&t=" + new Date().getTime();
  ...
  <body>
    ...
    <div id="toolbar">
      ...
      <div style="float: left">
        <a
          ...
          href="javascript:;"
          class="easyui-linkbutton"
          data-options="iconCls:'icon-vcard-edit',plain:true"
          >登记成绩</a
        >
      </div>
      <div style="float: left" class="datagrid-btn-separator"></div>
      <div>
        <a
          ...
          href="javascript:;"
          class="easyui-linkbutton"
          data-options="iconCls:'icon-chart_bar',plain:true"
          >成绩统计</a
        >
      </div>
    </div>
    ...
    <div id="escoreToolbar">
      <a
        ...
        >导出</a
      >
      <span id="escoreClazzSpan" style="margin-left: 10px"
        >班级：<input id="escoreClazzList" class="easyui-textbox" name="clazz"
      /></span>
    </div>

    <!-- 登记考试成绩 -->
    <div id="regEscoreDialog">
      <table id="regEscoreList" cellspacing="0" cellpadding="0"></table>
    </div>
    <div id="regEscoreToolbar">
      <a
        ...
        href="javascript:;"
        class="easyui-linkbutton"
        data-options="iconCls:'icon-folder-up',plain:true"
        >提交</a
      >
      <a
        id="clear"
        ...
        >清空</a
      >
      <span id="regClazzSpan" style="margin-left: 10px"
        >班级：<input id="regClazzList" class="easyui-textbox" name="clazz"
      /></span>
      <span id="regCourseSpan" style="margin-left: 10px"
        >课程：<input id="regCourseList" class="easyui-textbox" name="course"
      /></span>
    </div>
          ...
          <tr>
            ...
            <td>
              <input
                ...
                type="text"
                name="etime"
                data-options="required:true, missingMessage:'请选择日期', editable:false"
              />
            </td>
          </tr>
          <tr>
