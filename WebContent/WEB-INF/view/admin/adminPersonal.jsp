              ...
              handler: function () {
                ...
                if (!validate) {
                  ...
                  $.ajax({
                    type: "post",
                    url:
                      "SystemServlet?method=EditPasswod&t=" +
                      new Date().getTime(),
        ...
        $("#systemTable a").each(function () {
          $(this).click(function () {
            ...
            $.ajax({
              type: "post",
              url:
                "SystemServlet?method=EditSystemInfo&t=" + new Date().getTime(),
              data: data,
              success: function (msg) {
                if (msg == "success") {
      ...
      <div style="width: 650px">
        ...
        >
          <tr>
            ...
            <td width="100">
              <a data-options="iconCls:'icon-save'" class="easyui-linkbutton"
                >保存</a
              >
            </td>
          </tr>
          <tr>
            <td>禁止教师<br />登录系统</td>
            <td>
              <input id="forbid_teacher" ${systemInfo.forbidTeacher == 1 ?
              'checked' : ''} type="checkbox" name="forbidTeacher" />
            </td>
            <td>
              <a data-options="iconCls:'icon-save'" class="easyui-linkbutton"
                >保存</a
          ...
          <tr>
            <td>禁止学生<br />登录系统</td>
            <td>
              <input id="forbid_student" ${systemInfo.forbidStudent == 1 ?
              'checked' : ''} type="checkbox" name="forbidStudent" />
            </td>
            <td>
              <a data-options="iconCls:'icon-save'" class="easyui-linkbutton"
                >保存</a
          ...
          <tr>
            ...
            <td>
              <input
                id="notice_teacher"
                value="${systemInfo.noticeTeacher}"
          ...
          <tr>
            ...
            <td>
              <input
                id="notice_student"
                value="${systemInfo.noticeStudent}"
                style="width: 300px; height: 70px"
                data-options="multiline: true"
                class="easyui-textbox"
                type="text"
          ...
          <tr>
            ...
            <td>
              <input
                ...
                class="easyui-textbox"
                type="password"
                validType="oldPassword[${user.password}]"
          ...
          <tr>
            ...
            <td>
              <input
                ...
                data-options="required:true, missingMessage:'再次输入密码'"
              />
            </td>
          </tr>
        </table>
