...
public class TeacherService {
	...
	public void addTeacher(Teacher teacher) throws Exception {
		...
		try {
			...
			Object[] param = new Object[] { teacher.getNumber(), teacher.getName(), teacher.getSex(),
					teacher.getPhone(), teacher.getQq() };
			// 添加教师信息
			...
			dao.insertTransaction(conn, "INSERT INTO user(account, name, type) value(?,?,?)",
					new Object[] { teacher.getNumber(), teacher.getName(), User.USER_TEACHER });
	...
	public void editTeacher(Teacher teacher) throws Exception {
		...
		try {
			...
			Object[] param = new Object[] { teacher.getName(), teacher.getSex(), teacher.getPhone(), teacher.getQq(),
					teacher.getId() };
			// 修改教师信息
			...
			// 删除教师与课程的关联
			dao.deleteTransaction(conn, "DELETE FROM clazz_course_teacher WHERE teacherid =?",
	...
	public void editTeacherPersonal(Teacher teacher) {
		...
		// 更新信息
		dao.update(sql, new Object[] { teacher.getName(), teacher.getSex(), teacher.getPhone(), teacher.getQq(),
				teacher.getNumber() });

		dao.update("UPDATE user SET name=? WHERE account=?", new Object[] { teacher.getName(), teacher.getNumber() });
	}
